...
app.post('/insert-new-kpi', (req,res) => {
  ...
  const query = 'INSERT INTO kpi(quarter_month, num_employees_start, num_employees_end, average_num_employees, retention_rate, turnover_rate) VALUES (?, ?, ?, ?, ?, ?)';
  const values = [quarter_month, num_employees_start, num_employees_end, average_num_employees, retention_rate, turnover_rate];
